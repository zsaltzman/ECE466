...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[time_p, packetsize_p, junk1, junk2] = textread('bucket.txt', '%f %f %f %f');
...
i = 2;
cumulative_arrivals = zeros(1,2609950);
cumulative_arrivals(1) = packetsize_p(1);
cumulative_time = zeros(1,2609950);
cumulative_time(1) = 0;
time_p(8343) = 0;
while i <= 2609950
...
plot(cumulative_time, cumulative_arrivals) 
%%%%%%%%

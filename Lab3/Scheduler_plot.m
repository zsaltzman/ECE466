...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[time_p, packetsize_p, packet_type, backlog_1, backlog_2, backlog3, pdrop_1, pdrop_2, pdrop_3, delay_1, delay_2, delay_3] = textread('2_3N9PS.txt', '%f %f %f %f %f %f %f %f %f');
...
plot(subTime, backlog_1)

subplot(3,1,2)

plot(subTime, delay_1);

subplot(3,1,3)

plot(subTime, pdrop_1)
%%%%%%%%
